        ...
        <View style={styles.scrollmenu}>
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            <TouchableOpacity style={styles.menuButtonActive}>
              <Text style={styles.menuButtonTextActive}>Salad Buah Mix</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.menuButton}>
              <Text style={styles.menuButtonText}>Salad Naga</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.menuButton}>
              <Text style={styles.menuButtonText}>Salad Melon</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.menuButton}>
              <Text style={styles.menuButtonText}>Salad Mangga</Text>
            </TouchableOpacity>
          </ScrollView>
        </View>
        <View style={styles.cards}>
          <View style={styles.card}>
            <TouchableOpacity onPress={() => navigation.navigate('Detail')}>
              ...
              />
              <Text style={styles.cardTitle}>Salad Buah Mix</Text>
          ...
          <View style={styles.card}>
            <Image
              source={require('../assets/img/salad-naga.png')}
              style={styles.cardImage}
            />
            <Text style={styles.cardTitle}>Salad Naga</Text>
          ...
          <View style={styles.card}>
            <Image
              source={require('../assets/img/salad-melon.png')}
              style={styles.cardImage}
            />
            <Text style={styles.cardTitle}>Salad Melon</Text>
